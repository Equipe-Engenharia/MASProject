...
public class FrmExposicaoEdit extends JFrame {
	...
	public static void main(String[] args) {
		...
		try {
			new FrmExposicaoEdit().setVisible(true);
	...
	public void FrmExp() throws ParseException {
		...
		btnPesqId.setBounds(393, 26, 29, 23);
		contentPane.add(btnPesqId);

		btnPesqTitulo = new JButton("");
		btnPesqTitulo.setIcon(new ImageIcon("../MASProject/icons/search.png"));
