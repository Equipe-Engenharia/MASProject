...
public class ObraFile implements ArquivosICtrl{
	...
	public void escreveArquivo(String diretorio, String arquivo, String texto, Object object) throws IOException {
		...
		buffer.append("ID Obra :"+((ObraMdl) object).getId());
		buffer.append("\r\n");
		buffer.append("Nome do Artista :"+((ObraMdl) object).getArtista().getNome());
		buffer.append("\r\n");
		buffer.append("Nome da obra :"+((ObraMdl) object).getNome());
		buffer.append("\r\n");
		buffer.append("Descrição :"+((ObraMdl) object).getDescricao());
		buffer.append("\r\n");
		buffer.append("Categoria :"+((ObraMdl) object).getCategoria().getNome());
		buffer.append("\r\n");
		buffer.append("Data :"+((ObraMdl) object).getDataComposicao());
		buffer.append("\r\n");
		if(((ObraMdl) object).getImagem().contains("C:")){
			String text = ((ObraMdl) object).getImagem().replaceAll(".*:", "");
			buffer.append("Imagem :"+text);
			buffer.append("\r\n");
		}else{
			buffer.append("Imagem :"+((ObraMdl) object).getImagem());
			buffer.append("\r\n");
		}
		buffer.append("Material :"+((ObraMdl) object).getMaterial().getNome());
		buffer.append("\r\n");
		buffer.append("Setor :"+((ObraMdl) object).getSetor().getNome());
		buffer.append("\r\n");
		buffer.append("Valor :"+((ObraMdl) object).getPreco());
		buffer.append("\r\n");
		buffer.append("Obra Propria :"+((ObraMdl) object).isProprietario());
		buffer.append("\r\n");
		buffer.append("Status :"+((ObraMdl) object).getStatus());
		buffer.append("\r\n");
		buffer.append("---------------------------");
		buffer.append("\r\n");
		File arq = new File(diretorio, arquivo);
