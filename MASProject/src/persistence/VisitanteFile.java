...
public class VisitanteFile implements ArquivosICtrl{
	...
	public void escreveArquivo(String diretorio, String arquivo, String texto, Object object) throws IOException {
		...
		buffer.append("ID           : " + ((VisitanteMdl) object).getId());
		buffer.append("\r\n");
		buffer.append("Nome         : " + ((VisitanteMdl) object).getNome());
		buffer.append("\r\n");
		buffer.append("Nascimento   : " + ((VisitanteMdl) object).getDataNasc());
		buffer.append("\r\n");
		buffer.append("Nacionalidade: " + ((VisitanteMdl) object).getNacionalidade());
		buffer.append("\r\n");
